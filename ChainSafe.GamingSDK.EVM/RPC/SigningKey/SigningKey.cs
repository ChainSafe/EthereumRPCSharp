    ...
    public class SigningKey
    {
        ...
        public SigningKey(string privateKey)
        {
            ...
            //
             ...
             //var keyPair = new AsymmetricCipherKeyPair((AsymmetricKeyParameter) new ECPublicKeyParameters("EC",, parameters), (AsymmetricKeyParameter) new ECPrivateKeyParameters("EC", bigInteger, parameters))
